...
└── operations/            ← How the brand runs day-to-day: visual rules, themes, asset paths
```
...
---
title: Article Title
category: identity | audience | offers | voice | frameworks | strategy | content | proof | operations
...
| **operations** | How the brand runs day-to-day: visual generation rules, asset locations, visual themes, content production standards, integration research. Distinct from content/ (which is **what** to create) — operations is **how** to execute. |
